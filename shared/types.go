...
type Filament struct {
	...
	RecommendedSpeedMax float64  `json:"recommended_speed_max,omitempty"`
	MaxVolumetricSpeed  float64  `json:"max_volumetric_speed"`
	Density             float64  `json:"density"`
	DryTemperature      float64  `json:"dry_temp,omitempty"`
	DryHours            float64  `json:"dry_hours,omitempty"`
	FlowRatio           float64  `json:"flow_ratio"`
	PressureAdvance     *float64 `json:"pressure_advance"`
	Confidence          string   `json:"confidence"`
	Source              string   `json:"source"`
	TechnicalSources    []string `json:"technical_sources,omitempty"`
	Notes               string   `json:"notes"`
	SourcePath          string   `json:"source_path,omitempty"`
	OfficialProfile     bool     `json:"official_profile,omitempty"`
	MeasuredCalibration bool     `json:"measured_calibration,omitempty"`
}

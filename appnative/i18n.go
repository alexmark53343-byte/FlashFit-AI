...
var textByLanguage = map[string]map[string]string{
	"it": {
		...
		"manualIntro":            "Seleziona in ordine lo slicer, un profilo macchina Flashforge/Bambu Lab con ugello 0,4 mm, il profilo processo compatibile e il profilo filamento. Annullando una finestra conserverai il valore precedente.",
		"manualTitle":            "Configurazione manuale",
		"chooseSlicer":           "1/4 • Scegli Flash Studio, Bambu Studio o Orca",
		"chooseMachine":          "2/4 • Profilo macchina supportato 0,4 mm",
	...
	"en": {
		...
		"scanAgain": "Detect slicers again", "manualProfiles": "Configure profiles manually", "openLog": "Open diagnostics folder", "manualIntro": "Select the slicer, a supported Flashforge/Bambu Lab 0.4 mm machine profile, a compatible process profile and a filament profile in order. Canceling a window keeps the previous value.", "manualTitle": "Manual configuration", "chooseSlicer": "1/4 • Choose Flash Studio, Bambu Studio or Orca", "chooseMachine": "2/4 • Supported 0.4 mm machine profile", "chooseProcess": "3/4 • Compatible process profile", "chooseBaseFilament": "4/4 • Base filament profile", "programs": "Programs", "jsonProfiles": "JSON profiles",
	},
	"fr": {

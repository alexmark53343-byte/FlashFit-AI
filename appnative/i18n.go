...
var textByLanguage = map[string]map[string]string{
	"it": {
		...
		"openFlash":              "Apri nello slicer",
		"ready":                  "Pronto per analizzare",
		"readyOpen":              "Tutto pronto per lo slicer",
		"statusCatalog":          "Catalogo caricato: %d filamenti. Rilevo gli slicer…",
		"statusDiscovering":      "Rilevamento degli slicer e dei profili…",
		"statusDiscoveryDone":    "Rilevamento completato: %d filamenti e %d profili qualità.",
		"statusPrinterSelected":  "Stampante selezionata: %s.",
		...
		"statusImporting":        "Lo slicer sta creando e verificando il progetto 3MF…",
		...
		"profilesMissing":        "Mancano lo slicer o uno dei profili base completi.",
		...
		"source":                 "Fonte",
		"calibration":            "Calibrazione bobina",
		"calibrationMeasured":    "misurata",
		"calibrationBaseline":    "baseline tecnica, misura richiesta",
		"drying":                 "Essiccazione",
		...
		"scanAgain":              "Rileva di nuovo gli slicer",
		"manualProfiles":         "Configura profili manualmente",
		"openLog":                "Apri cartella diagnostica",
		"manualIntro":            "Seleziona in ordine lo slicer, un profilo macchina Flashforge/Bambu Lab supportato, il profilo processo compatibile e il profilo filamento. Annullando una finestra conserverai il valore precedente.",
		"manualTitle":            "Configurazione manuale",
		"chooseSlicer":           "1/4 • Scegli Flash Studio, Bambu Studio o Orca",
		"chooseMachine":          "2/4 • Profilo macchina supportato",
		"chooseProcess":          "3/4 • Profilo processo compatibile",
		"chooseBaseFilament":     "4/4 • Profilo filamento base",
		"programs":               "Programmi",
		"jsonProfiles":           "Profili JSON",
		"printerEyebrow":         "PROFILO MACCHINA",
		"printerTitle":           "Scegli stampante",
		"printerSubtitle":        "Seleziona profilo macchina e ugello installato.",
		"printerUse":             "Usa stampante",
		"printerNozzle":          "Ugello",
		"printerBuild":           "Volume",
		"printerBuildUnknown":    "Volume n/d",
		"printerMotion":          "Movimento",
		"printerEnclosed":        "chiusa",
		"printerOpenFrame":       "aperta",
		"printerPreviewOnly":     "Anteprima visiva mostrata solo in questo menu.",
		"filamentEyebrow":        "MATERIALE",
		"filamentSubtitle":       "Cerca e scegli il profilo filamento da usare.",
	},
	"en": {
		"appTitle": "FlashFit AI Spatial", "device": "Choose printer", "nozzle": "0.4 mm nozzle", "language": "Language", "advanced": "Advanced",
		"stepModel": "Import model", "stepFilament": "Choose filament", "stepQuality": "Print quality", "stepOpen": "Open in slicer",
		...
		"filamentSelected": "Selected", "noFilament": "No filament", "qualityFast": "Fast", "qualityBalanced": "Balanced", "qualityPerfect": "Perfect", "openFlash": "Open in slicer",
		"ready": "Ready to analyze", "readyOpen": "Everything is ready for the slicer", "statusCatalog": "Catalog loaded: %d filaments. Detecting slicers…", "statusDiscovering": "Detecting slicers and installed profiles…", "statusDiscoveryDone": "Detection complete: %d filaments and %d quality profiles.",
		"statusAnalyzing": "Protected model analysis in progress…", "statusAnalysisCanceled": "Analysis canceled.", "statusAnalysisFailed": "Analysis failed: %s", "statusAnalysisBlocked": "Model blocked: %s", "statusAnalysisReady": "Model analyzed. Choose filament and quality.", "statusPrinterSelected": "Selected printer: %s.",
		"statusCancelImport": "Canceling import…", "statusCancelAnalysis": "Canceling analysis…", "statusImporting": "The slicer is creating and verifying the 3MF project…", "statusImportCanceled": "Import canceled: %s", "statusImportDone": "Verified project opened: %s",
		...
		"analyzeFirst": "Analyze the model first.", "profilesMissing": "The slicer or one of the complete base profiles is missing.", "importBlocked": "Import blocked", "modelRejected": "Model rejected", "internalError": "FlashFit AI detected an internal error. The log was saved to:\n%s", "alreadyRunning": "FlashFit AI is already open. Check the taskbar.", "databaseError": "Unable to load the filament database: %s",
		...
		"material": "Material", "variant": "Variant", "nozzleTemp": "Nozzle", "bedTemp": "Bed", "reliability": "Reliability", "source": "Source", "calibration": "Spool calibration", "calibrationMeasured": "measured", "calibrationBaseline": "technical baseline, measurement required", "drying": "Drying", "shownResults": "Showing %d of %d results. Narrow your search.", "analysisSummary": "%s • %d triangles • %.1f × %.1f × %.1f mm", "supportsOn": "Supports recommended", "supportsOff": "Supports not required",
		"scanAgain": "Detect slicers again", "manualProfiles": "Configure profiles manually", "openLog": "Open diagnostics folder", "manualIntro": "Select the slicer, a supported Flashforge/Bambu Lab machine profile, a compatible process profile and a filament profile in order. Canceling a window keeps the previous value.", "manualTitle": "Manual configuration", "chooseSlicer": "1/4 • Choose Flash Studio, Bambu Studio or Orca", "chooseMachine": "2/4 • Supported machine profile", "chooseProcess": "3/4 • Compatible process profile", "chooseBaseFilament": "4/4 • Base filament profile", "programs": "Programs", "jsonProfiles": "JSON profiles", "printerEyebrow": "MACHINE PROFILE", "printerTitle": "Choose printer", "printerSubtitle": "Select the machine profile and installed nozzle.", "printerUse": "Use printer", "printerNozzle": "Nozzle", "printerBuild": "Volume", "printerBuildUnknown": "Volume n/a", "printerMotion": "Motion", "printerEnclosed": "enclosed", "printerOpenFrame": "open", "printerPreviewOnly": "Visual preview shown only in this menu.", "filamentEyebrow": "MATERIAL", "filamentSubtitle": "Search and choose the filament profile to use.",
	},
	"fr": {
		"appTitle": "FlashFit AI Spatial", "device": "Choisir l’imprimante", "nozzle": "Buse 0,4 mm", "language": "Langue", "advanced": "Avancé",
		"stepModel": "Importer le modèle", "stepFilament": "Choisir le filament", "stepQuality": "Qualité d'impression", "stepOpen": "Ouvrir dans le slicer", "dropTitle": "Glissez-déposez votre modèle ici", "dropSubtitle": "STL, OBJ ou 3MF", "chooseModel": "Choisir un modèle…", "noModel": "Aucun modèle sélectionné", "modelReady": "Modèle prêt", "analyzing": "Analyse…",
		"filamentSelected": "Sélectionné", "noFilament": "Aucun filament", "qualityFast": "Rapide", "qualityBalanced": "Équilibrée", "qualityPerfect": "Parfaite", "openFlash": "Ouvrir dans le slicer", "ready": "Prêt à analyser", "readyOpen": "Tout est prêt pour le slicer",
		"statusCatalog": "Catalogue chargé : %d filaments. Détection de Flash Studio…", "statusDiscovering": "Détection de Flash Studio et des profils…", "statusDiscoveryDone": "Détection terminée : %d filaments et %d profils qualité.", "statusPrinterSelected": "Imprimante sélectionnée : %s.", "statusAnalyzing": "Analyse protégée du modèle…", "statusAnalysisCanceled": "Analyse annulée.", "statusAnalysisFailed": "Échec de l'analyse : %s", "statusAnalysisBlocked": "Modèle bloqué : %s", "statusAnalysisReady": "Modèle analysé. Choisissez filament et qualité.", "statusCancelImport": "Annulation de l'importation…", "statusCancelAnalysis": "Annulation de l'analyse…", "statusImporting": "Flash Studio crée et vérifie le projet 3MF…", "statusImportCanceled": "Importation annulée : %s", "statusImportDone": "Projet vérifié ouvert : %s",
		...
		"filamentTitle": "Choisir le filament", "searchFilament": "Rechercher marque, gamme ou matériau", "useFilament": "Utiliser ce filament", "close": "Fermer", "internal": "interne", "fromBase": "depuis le profil de base", "localProfile": "profil Flash Studio local : %s", "material": "Matériau", "variant": "Variante", "nozzleTemp": "Buse", "bedTemp": "Plateau", "reliability": "Fiabilité", "source": "Source", "calibration": "Calibration de la bobine", "calibrationMeasured": "mesurée", "calibrationBaseline": "base technique, mesure requise", "drying": "Séchage", "shownResults": "%d résultats affichés sur %d. Affinez la recherche.", "analysisSummary": "%s • %d triangles • %.1f × %.1f × %.1f mm", "supportsOn": "Supports recommandés", "supportsOff": "Supports non nécessaires",
	...
	"es": {
		"appTitle": "FlashFit AI Spatial", "device": "Elegir impresora", "nozzle": "Boquilla 0,4 mm", "language": "Idioma", "advanced": "Avanzado",
		"stepModel": "Importar modelo", "stepFilament": "Elegir filamento", "stepQuality": "Calidad de impresión", "stepOpen": "Abrir en el slicer", "dropTitle": "Arrastra y suelta aquí tu modelo", "dropSubtitle": "STL, OBJ o 3MF", "chooseModel": "Elegir modelo…", "noModel": "Ningún modelo seleccionado", "modelReady": "Modelo listo", "analyzing": "Analizando…",
		"filamentSelected": "Seleccionado", "noFilament": "Ningún filamento", "qualityFast": "Rápida", "qualityBalanced": "Equilibrada", "qualityPerfect": "Perfecta", "openFlash": "Abrir en el slicer", "ready": "Listo para analizar", "readyOpen": "Todo listo para el slicer",
		"statusCatalog": "Catálogo cargado: %d filamentos. Detectando Flash Studio…", "statusDiscovering": "Detectando Flash Studio y perfiles…", "statusDiscoveryDone": "Detección completa: %d filamentos y %d perfiles de calidad.", "statusPrinterSelected": "Impresora seleccionada: %s.", "statusAnalyzing": "Análisis protegido del modelo…", "statusAnalysisCanceled": "Análisis cancelado.", "statusAnalysisFailed": "Error de análisis: %s", "statusAnalysisBlocked": "Modelo bloqueado: %s", "statusAnalysisReady": "Modelo analizado. Elige filamento y calidad.", "statusCancelImport": "Cancelando importación…", "statusCancelAnalysis": "Cancelando análisis…", "statusImporting": "Flash Studio está creando y verificando el proyecto 3MF…", "statusImportCanceled": "Importación cancelada: %s", "statusImportDone": "Proyecto verificado abierto: %s",
		...
		"filamentTitle": "Elegir filamento", "searchFilament": "Buscar marca, línea o material", "useFilament": "Usar este filamento", "close": "Cerrar", "internal": "interno", "fromBase": "del perfil base", "localProfile": "perfil local de Flash Studio: %s", "material": "Material", "variant": "Variante", "nozzleTemp": "Boquilla", "bedTemp": "Cama", "reliability": "Fiabilidad", "source": "Fuente", "calibration": "Calibración de bobina", "calibrationMeasured": "medida", "calibrationBaseline": "base técnica, medición necesaria", "drying": "Secado", "shownResults": "Mostrando %d de %d resultados. Limita la búsqueda.", "analysisSummary": "%s • %d triángulos • %.1f × %.1f × %.1f mm", "supportsOn": "Soportes recomendados", "supportsOff": "Soportes no necesarios",
	...
	"de": {
		"appTitle": "FlashFit AI Spatial", "device": "Drucker wählen", "nozzle": "0,4-mm-Düse", "language": "Sprache", "advanced": "Erweitert",
		"stepModel": "Modell importieren", "stepFilament": "Filament wählen", "stepQuality": "Druckqualität", "stepOpen": "Im Slicer öffnen", "dropTitle": "Modell hierher ziehen und ablegen", "dropSubtitle": "STL, OBJ oder 3MF", "chooseModel": "Modell wählen…", "noModel": "Kein Modell ausgewählt", "modelReady": "Modell bereit", "analyzing": "Analyse…",
		"filamentSelected": "Ausgewählt", "noFilament": "Kein Filament", "qualityFast": "Schnell", "qualityBalanced": "Ausgewogen", "qualityPerfect": "Perfekt", "openFlash": "Im Slicer öffnen", "ready": "Bereit zur Analyse", "readyOpen": "Alles bereit für den Slicer",
		"statusCatalog": "Katalog geladen: %d Filamente. Flash Studio wird erkannt…", "statusDiscovering": "Flash Studio und Profile werden erkannt…", "statusDiscoveryDone": "Erkennung abgeschlossen: %d Filamente und %d Qualitätsprofile.", "statusPrinterSelected": "Ausgewählter Drucker: %s.", "statusAnalyzing": "Geschützte Modellanalyse läuft…", "statusAnalysisCanceled": "Analyse abgebrochen.", "statusAnalysisFailed": "Analyse fehlgeschlagen: %s", "statusAnalysisBlocked": "Modell blockiert: %s", "statusAnalysisReady": "Modell analysiert. Filament und Qualität wählen.", "statusCancelImport": "Import wird abgebrochen…", "statusCancelAnalysis": "Analyse wird abgebrochen…", "statusImporting": "Flash Studio erstellt und prüft das 3MF-Projekt…", "statusImportCanceled": "Import abgebrochen: %s", "statusImportDone": "Geprüftes Projekt geöffnet: %s",
